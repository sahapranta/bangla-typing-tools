...
VirtualKeyboard.addLayout({code:'CHR',name:'Cherokee Phonetic',keys:'`1234567890-=\\qwertyuiop[]asdfghjkl;\'zxcvbnm,./',shift: {0:'~!@#$%^&*()_+|',24:'{}',35:':"',44:'<>?'},cbk:new function () {
...
VirtualKeyboard.addLayout({code:'HI-IN',name:'Hindi (Inscript)',keys:'`1234567890-ृ\\ौैाीूबहगदजड़ोे्िुपरकतचटॉंमनवलस,.य',shift: {0:'~ऍॅ्रजतकश()रऋ|औऐआईऊभङघधझढञओएअइउफऱखथछठ',38:'ँणVBळशष।य़'}});
...
VirtualKeyboard.addLayout({code:'IU-IKU',name:'Inuktitut Phonetic',keys:'`1234567890-=\\qwertyuiop[]asdfghjklł\'zxcvbnm,./',shift: {0:'~!@#$%^&*()_+|',24:'{}',31:'ᕼ',35:':"',41:'ᖯ',44:'<>?'},cbk:VirtualKeyboard.Langs.IKU.charProcessor});
VirtualKeyboard.addLayout({code:'IU-IKU',name:'Inuktitut Syllabic',keys:'`1234567890-=\\ᖃ ᐁᕋᑕᐂᐅᐃ ᐸ[]ᐊᓴ ᖕᒐᕼᔭᑲᓚᐧ\' ᖤ ᕙᖯᓇᒪ,.ᖤ',shift: {0:'~!@#$%^&*()_+|',24:'{}',35:':"',44:'<>?'},cbk:VirtualKeyboard.Langs.IKU.charProcessor});
...
VirtualKeyboard.addLayout({code:'LB-LU',name:'Luxembourgish ',keys:'§1234567890\'^$qwertzuiopè¨asdfghjkléàyxcvbnm,.-',shift: {0:'°+"*ç%&/()=?`£',24:'ü!',35:'öä',44:';:_'},alt: {1:'¦@#°§¬|¢',11:'´~}',16:'€',24:'[]',36:'{'},dk:'´^¨'});
...
VirtualKeyboard.addLayout({code:'NE-NP',name:'Nepali ',keys:'ञज्ञघङझछटठडढण(.्रत्रधभचतथगषयउृेबकमानजवपिसुशहअखदलफ,।र',shift: {0:'ञ्१२३४५६७८९०)ं्ोध्भ्च्त्थ्ग्क्षइएर्ैब्क्म्ँन्ज्व्प्ीस्ूश्ह्ऋख्द्ल्ः?श्ररू'},alt: {1:'123456789',12:'+',23:'ऊ',25:'औ',39:'आ'}});
...
VirtualKeyboard.addLayout({code:'PA-IN',name:'Punjabi',keys:' 1234567890-  ੌੈਾੀੂਬਹਗਦਜਡ਼ੋੇ੍ਿੁਪਰਕਤਚਟ ੰਮਨਵਲਸ,.ਯ',shift: {0:'੍ਹ੍ਵ੍ਯ੍ਰੱ',9:'()',14:'ਔਐਆਈਊਭਙਘਧਝਢਞਓਏਅਇਉਫ',33:'ਖਥਛਠ',38:'ਂਣ',41:'ੲਲ਼ਸ਼',45:'।'},alt: {1:'੧੨੩੪੫੬੭੮੯੦',21:'ਗ਼',23:'ਜ਼ੜ',31:'ਫ਼',33:'ਖ਼',41:'ੳ',45:'॥'}});
